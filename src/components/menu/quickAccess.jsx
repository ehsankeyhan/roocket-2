...
export default function QuickAccess() {
  ...
  return (
    <div onClick={()=>dispatch(toggleQuickAccess())} className={`hover:bg-opacity-65 transition-all duration-300 ease-in-out z-50 relative cursor-pointer w-24 h-24 bg-white shadow-2xl backdrop-blur-lg bg-opacity-30 flex justify-center items-center rounded-2xl }`}>
